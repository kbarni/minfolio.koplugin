...
-- Native mindmap widgets (PLAN.md §5 Tier 5, §10 step 7); MindmapCanvas is
-- required only by minfolio_map_view.lua itself (MindmapView:rebuild
-- instantiates it), not read directly here.
...
-- MindmapCanvas/MindmapView moved to minfolio_map_canvas.lua / minfolio_map_view.lua
-- (PLAN.md §5 Tier 5, §10 step 7). MDEdit:openMindmap (below) is the only remaining
-- reference to the mindmap in this file: it constructs the view as
-- `MindmapView:new{ editor = self }`.
